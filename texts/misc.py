...
personal_order_saved = 'Проект сохранен и ждет отправки'

ask_personal_order_worker = """
Выбери <b>исполнителя</b> в списке своих чатов. \
Когда исполнитель примет проект, ваш диалог будет переведен в <b>"нору"</b> - комнату для обсуждения. \
Ссылка на "нору" придет вам в меню бота.
"""

you_received_personal_order = """
Тебе прислали персональный заказ - примите его, чтобы узнать детали.
"""
